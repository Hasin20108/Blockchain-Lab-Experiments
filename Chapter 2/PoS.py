...
class Block:
    ...
    def calculate_hash(self):
        res = hashlib.sha256((str(self.height)+str(self.data) + str(self.prev_hash) + str(self.timestamp)).encode()).digest().hex()
        return res        
...
class Blockchain:
    ...
    def addBlock(self, data, difficulty):
        ...
        print(f"Block {block_height} is successfully mined")
